                ...
                <template slot-scope="scope">
                    ...
                    <div v-else>
                        <div v-for="menu in scope.row.menus" style="text-align: left">
                            ...
                            <el-tag v-for="perm in menu.permissions" :key="perm.permissionName"
            ...
            <el-table-column align="center" label="管理" width="220"
                ...
                <template slot-scope="scope">
                    <div v-if="scope.row.roleName!='管理员'">
                        ...
                        <el-button v-if=" scope.row.users && scope.row.users.length===0 && hasPerm('role:delete')"
                                   type="danger"
                                   icon="delete"
              ...
              <el-button :type="isMenuNone(_index)?'':(isMenuAll(_index)?'success':'primary')" size="mini"
                        ...
                        <div style="display: inline-block;margin-left:20px;">
                            <el-checkbox-group v-model="tempRole.permissions">
                                <el-checkbox v-for="perm in menu.permissions" :label="perm.id"
